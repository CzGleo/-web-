...
import com.czg.seckillsystem.dao.ItemDOMapper;
import com.czg.seckillsystem.dao.ItemStockDOMapper;
import com.czg.seckillsystem.dao.StockLogDOMapper;
import com.czg.seckillsystem.dataobject.ItemDO;
import com.czg.seckillsystem.dataobject.ItemStockDO;
...
import com.czg.seckillsystem.service.model.PromoModel;
import com.czg.seckillsystem.validator.ValidationResult;
import com.czg.seckillsystem.validator.ValidatorImpl;
...
public class ItemServiceImpl implements ItemService {
    ...
    public boolean decreaseStock(Integer itemId, Integer amount) throws BusinessException {
        // Redis库存扣减，并由RocketMq发送消息同步数据库
        long result = redisTemplate.opsForValue().increment("promo_item_id_" + itemId, amount.intValue() * -1);
        if (result > 0) {
            return true;
        } else if (result == 0){
            // 标识库存售罄
    ...
    public boolean increaseStock(Integer itemId, Integer amount) throws BusinessException {
        redisTemplate.opsForValue().increment("promo_item_id_" + itemId, amount.intValue());
        return true;
    }
